...
__attribute__((__aligned__(PAGE_SIZE))) uint64_t __kpud[512] = {
    K2P(__kpte) + PTE_TABLE,
    0x40000000 | PTE_KERNEL_DEVICE,
    0,
    0xC0000000 | PTE_KERNEL_DEVICE,
};

__attribute__((__aligned__(PAGE_SIZE))) uint64_t kpgdir[512] = {K2P(__kpud) + PTE_TABLE};
